...
#'
#' @returns A list with the tibbles 'cha' and 'res' that provide the
...
#' @importFrom terra rast rasterize vect zonal
#' @importFrom tibble add_column tibble
#' @importFrom sf read_sf st_area st_buffer st_drop_geometry
#'
#' @export
#'
