...
#' @importFrom terra rast vect zonal
...
#' to simulate recharge from the aquifer into the channels.
#'
#' @param txt_path Path of the projects TxtInOut folder
#'
#' @returns The function adds the SWAT+ input file aqu_cha.lin which links
#'   aquifer ids and channel ids and updates the file.cio to point to this
#'   link file.
#'
